...
class RelatedMetaclass(type):
    def __new__(cls, name, bases, attrs):
        super_new = super(RelatedMetaclass, cls).__new__
        parents = [
            b for b in bases if isinstance(b, RelatedMetaclass) and
...
class Related(six.with_metaclass(RelatedMetaclass, object)):
    pass
#   _MATCH_YEAR = r'{year}'
