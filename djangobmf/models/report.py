...
class Report(models.Model):
    ...
    """
    slug = models.CharField(_('Slug'), max_length=120, editable=False)
    ...
    renderer_pk = models.PositiveIntegerField(null=True, blank=True, editable=False)
    has_object = models.NullBooleanField(editable=False)
